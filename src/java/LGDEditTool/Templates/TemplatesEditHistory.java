...
public class TemplatesEditHistory {
	...
	static public String editHistory(String ksite,String kvsite, User user, String sort) throws Exception {
		...
		//kmappings
		//insert tablehead
		String re = "\t\t\t\t<h2>K-Mappings history</h2>\n";
		re += "\t\t\t\t<table class=\"table\">\n";
		re += "\t\t\t\t\t<tr class=mapping>\n";
		re += "\t\t\t\t\t\t<th><a href=\"?tab=history&ksite=" + ksite + "&kvsite=" + kvsite + "\">timestamp</a></th>\n";
		re += "\t\t\t\t\t\t<th><a href=\"?tab=history&sort=k&ksite=" + ksite + "&kvsite=" + kvsite + "\">k</a></th>\n";
		re += "\t\t\t\t\t\t<th><a href=\"?tab=history&sort=property&ksite=" + ksite + "&kvsite=" + kvsite + "\">property</a></th>\n";
		re += "\t\t\t\t\t\t<th><a href=\"?tab=history&sort=object&ksite=" + ksite + "&kvsite=" + kvsite + "\">object</a></th>\n";
		re += "\t\t\t\t\t\t<th>affected Entities</th>\n";
		re += "\t\t\t\t\t\t<th>action</th>\n";
		re += "\t\t\t\t\t\t<th><a href=\"?tab=history&sort=user_id&ksite=" + ksite + "&kvsite=" + kvsite + "\">user</a></th>\n";
		re += "\t\t\t\t\t\t<th>comment</th>\n";
		re += "\t\t\t\t\t\t<th>restore</th>\n";
		re += "\t\t\t\t\t</tr>\n";

		//insert edithistory from db for k-mappings
		re += searchKHistoryDB(Integer.parseInt(ksite),Integer.parseInt(kvsite),user, sort);
		...
		if ( Integer.valueOf(ksite) > 1 ) {
			...
			re += "\t\t\t\t\t<a href=\"?tab=history&ksite="+ prevsite.toString() + "&kvsite="+kvsite + (sort.equals("") ? "" : "&sort=" + sort) + "\">&#60;prev</a>&nbsp;&nbsp;&nbsp;";
		}
		Integer nextsite=Integer.valueOf(ksite)+1;
		re += "<a href=\"?tab=history&ksite="+ nextsite.toString() + "&kvsite="+kvsite + (sort.equals("") ? "" : "&sort=" + sort) + "\">next&#62;</a>\n";
		re += "\t\t\t\t</div>\n";

		//kmappings
		//insert tablehead
		re += "\t\t\t\t<h2>KV-Mappings history</h2>\n";
		re += "\t\t\t\t<table class=\"table\">\n";
		re += "\t\t\t\t\t<tr class=mapping>\n";
		re += "\t\t\t\t\t\t<th><a href=\"?tab=history&ksite=" + ksite + "&kvsite=" + kvsite + "\">timestamp</a></th>\n";
		re += "\t\t\t\t\t\t<th><a href=\"?tab=history&sort=k&ksite=" + ksite + "&kvsite=" + kvsite + "\">k</a></th>\n";
		re += "\t\t\t\t\t\t<th><a href=\"?tab=history&sort=v&ksite=" + ksite + "&kvsite=" + kvsite + "\">v</a></th>\n";
		re += "\t\t\t\t\t\t<th><a href=\"?tab=history&sort=object&ksite=" + ksite + "&kvsite=" + kvsite + "\">property</a></th>\n";
		re += "\t\t\t\t\t\t<th><a href=\"?tab=history&sort=object&ksite=" + ksite + "&kvsite=" + kvsite + "\">object</a></th>\n";
		re += "\t\t\t\t\t\t<th>affected Entities</th>\n";
		re += "\t\t\t\t\t\t<th>action</th>\n";
		re += "\t\t\t\t\t\t<th><a href=\"?tab=history&sort=user_id&ksite=" + ksite + "&kvsite=" + kvsite + "\">user</a></th>\n";
		...
		re += searchKVHistoryDB(Integer.parseInt(ksite),Integer.parseInt(kvsite),user, sort);
		...
		if( Integer.valueOf(kvsite) > 1 ) {
			...
			re += "\t\t\t\t\t<a href=\"?tab=history&ksite="+ ksite + "&kvsite="+prevsite.toString() + (sort.equals("") ? "" : "&sort=" + sort) + "\">&#60;prev</a>&nbsp;&nbsp;&nbsp;";
		}

		Integer nextsite2=Integer.valueOf(kvsite)+1;
		re += "\t\t\t\t\t<a href=\"?tab=history&ksite="+ ksite + "&kvsite=" + nextsite2.toString() + (sort.equals("") ? "" : "&sort=" + sort) + "\">next&#62;</a>\n";
		re += "\t\t\t\t</div>\n";
	 ...
	 * @throws Exception 
	 */
	static private String searchKHistoryDB(int ksite,int kvsite,User user, String sort) throws Exception {
		String re = "";
		...
		for ( int i = 0; i <  a.length; i++ ) {
			re += addkMapping(i,a[i][0].toString(), a[i][1].toString(), a[i][2].toString(), a[i][3].toString(),a[i][7].toString(),a[i][4].toString(),a[i][5].toString(),a[i][6].toString(),user,ksite,kvsite);
		}
	 ...
	 * @throws Exception 
	 */
	static private String searchKVHistoryDB(int ksite,int kvsite,User user, String sort) throws Exception {
		String s = "";
		DatabaseBremen database = DatabaseBremen.getInstance();
		...
		for ( int i = 0; i <  a.length; i++ ) {
			s += addkvMapping(i,a[i][0].toString(),a[i][1].toString(), a[i][2].toString(), a[i][3].toString(), a[i][4].toString(),a[i][8].toString(),a[i][5].toString(),a[i][6].toString(),a[i][7].toString(),user,ksite,kvsite);
		}
		return s;
	}
	 ...
	 * @return 
	 */
	static private String addkMapping(int id, String k, String property, String object, String affectedEntities,String action, String user_id, String comment, String timestamp, User user, int ksite, int kvsite) {
	 ...
	 * @return 
	 */
	static private String addkvMapping(int id, String k, String v, String property, String object, String affectedEntities, String action, String user_id, String comment, String timestamp, User user, int ksite, int kvsite) {
